...
class ApiController extends Controller
{
    ...
    public function test_connection_to_dokumentace()
    {
        ...
        try {
            return Http::timeout(3)->get($this->iptvdokuUriApiConnectionTest, [
    ...
    {
        try {
            return  Http::timeout(3)->get($this->iptvdokuUriApiStreamInfo, [
    ...
    {
        return Http::get($this->iptvdokuUriApiStreams, [
            'hello' => $this->hello_dokumentace,
        ]);
    }
    ...
    {
        return Http::timeout(3)->get('http://iptvdoku.grapesc.cz/api/v2/channel/logo', [
            'is_dohled' => true,
            'streamId' => $streamId
        ]);
    }
